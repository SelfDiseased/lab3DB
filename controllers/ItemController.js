class ItemController {
    constructor(sequelize) {
        this.itemModel = require('../models/ItemModel')(sequelize);
    }
    ...
    async updateById(id, price, availability, name) {
        const item = await this.itemModel.updateById(id, price, availability, name);
