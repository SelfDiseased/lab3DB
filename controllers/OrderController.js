class OrderController {
    constructor(sequelize) {
        this.orderModel = require('../models/OrderModel')(sequelize);
    }
    ...
    async updateById(id, delivery_date, customer_email) {
        const order = await this.orderModel.updateById(id, delivery_date, customer_email);
